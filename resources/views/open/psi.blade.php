...
@section('content_js')
<script src="https://maps.google.com/maps/api/js?key=AIzaSyAQpaNq3ytN3ktWcrk6_Gj2lCo3uKr--ds&callback=initMap" async defer type="text/javascript"></script>
<script type="text/javascript" src="{{ asset('/js/open/psi.js') }}"></script>
@endsection
...
<div class="container">
	<div class="title-menu">
		...
		<div class="title-col">
			<div class="excerpt"><a href="#">{{ $postType }}</a></div>
		</div>
	</div>
</div><!-- /.container -->
	  ...
	  <div class="row">
		<div class="col-xs-6 col-sm-12">
		  <div class="well well-sm">
			<h4>顏色表示</h4>
			<ol class="list-unstyled">
			  <li><span class="list_color" style="background:#00ff00;">&#60;=50 良好</span></li>
			  <li><span class="list_color" style="background:#ffdd00;">&#60;=100 普通</span></li>
			  <li><span class="list_color" style="background:#ff0000;">&#60;200 不良</span></li>
			  <li><span class="list_color" style="color:white;background:#800080;">&#60;300 非常不良</span></li>
			  <li><span class="list_color" style="color:white;background:#633300;">&#62;=300 有害</span></li>
			</ol>
		  </div>
		</div>
		<div class="col-xs-6 col-sm-12">
